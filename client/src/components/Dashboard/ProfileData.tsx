          ...
          <div className="container-fluid">
            ...
            <div className="row">
              <div className="col-lg-9 mb-4">
                ...
                <div className="card shadow mb-4">
                  <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">All Profile Details</h6>
                  </div>
                  <div className="card-body">
                    ...
                    <div className="tab-content mt-3">
                        ...
                        <div className="accordion" id="accordionExample">
                          ...
                          <div className="card">
                            <div className="card-header" id="heading0">
                              <h2 className="mb-0">
                                <button
                                  className={`btn btn-link btn-block text-left ${activeIndex === 0 ? '' : 'collapsed'}`}
                                  onClick={() => toggle(0)}
                          ...
                          <div className="card">
                            <div className="card-header" id="heading1">
                              <h2 className="mb-0">
                                <button
                                  className={`btn btn-link btn-block text-left ${activeIndex === 1 ? '' : 'collapsed'}`}
                                  onClick={() => toggle(1)}
                                  aria-expanded={activeIndex === 1}
                                  aria-controls="collapse1"
                                >
                                  Log <small className="text-muted">2025-06-27 09:12 AM</small>  <span className="badge badge-success">Success</span>
                                ...
                                <div className="">
                                  <ul className="list-group">
                                    <li className="list-group-item d-flex justify-content-between align-items-center">
                                      <div>
                                        <strong>Login</strong> — Alice Smith<br />
                                        <small className="text-muted">2025-06-27 09:12 AM</small>
                                      </div>
                                      <span className="badge badge-success">Success</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center">
                                      <div>
                                        <strong>Profile Updated</strong> — Bob Johnson<br />
                                        <small className="text-muted">2025-06-26 05:40 PM</small>
                                      </div>
                                      <span className="badge badge-primary">Updated</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center">
                                      <div>
                                        <strong>Password Changed</strong> — Carol Davis<br />
                                        <small className="text-muted">2025-06-25 03:28 PM</small>
                                      </div>
                                      <span className="badge badge-warning">Security</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center">
                                      <div>
                                        <strong>Logout</strong> — Alice Smith<br />
                                        <small className="text-muted">2025-06-25 01:10 PM</small>
                                      </div>
                          ...
                          <div className="card">
                            <div className="card-header" id="heading2">
                              <h2 className="mb-0">
                                <button
                                  className={`btn btn-link btn-block text-left ${activeIndex === 2 ? '' : 'collapsed'}`}
                                  onClick={() => toggle(2)}
                          ...
                          <div className="timeline">
                            <div className="timeline-item">
                              ...
                              <div className="timeline-content">
                                ...
                                <span className="timestamp">2025-06-27 09:12 AM</span>
                              </div>
                            </div>
                            ...
                            <div className="timeline-item">
                              ...
                              <div className="timeline-content">
                                ...
                                <span className="timestamp">2025-06-26 05:40 PM</span>
                              </div>
                            </div>
                            ...
                            <div className="timeline-item">
                              ...
                              <div className="timeline-content">
                                ...
                                <span className="timestamp">2025-06-25 03:28 PM</span>
                              </div>
                            </div>
                            ...
                            <div className="timeline-item">
                              ...
                              <div className="timeline-content">
                                ...
                                <span className="timestamp">2025-06-25 01:10 PM</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className={`tab-pane fade ${activeTab === 'objects' ? 'show active' : ''}`}>
              ...
              <div className="col-lg-3 mb-4">
                ...
                <div className="card shadow mb-4">
                  <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Activity Log</h6>
                  </div>
                  <div className="card-body">
